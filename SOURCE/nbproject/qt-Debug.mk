...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sat Jan 21 15:42:14 2012
# Project:  nbproject/qt-Debug.pro
# Template: app
# Command: /home/Ira/QtSDK/Desktop/Qt/474/gcc/bin/qmake VPATH=. -o qttmp-Debug.mk nbproject/qt-Debug.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/Ira/QtSDK/Desktop/Qt/474/gcc/lib
...
SOURCES       = gsConnect.cpp \
		...
		moc_MainWindow.cpp
OBJECTS       = build/Debug/GNU-Linux-x86/gsConnect.o \
		...
		build/Debug/GNU-Linux-x86/gsMessageEditor.o \
		build/Debug/GNU-Linux-x86/main.o \
		build/Debug/GNU-Linux-x86/msg.o \
		build/Debug/GNU-Linux-x86/Receive.o \
		build/Debug/GNU-Linux-x86/gsReceive.o \
		build/Debug/GNU-Linux-x86/gsReceiveSL.o \
		build/Debug/GNU-Linux-x86/msgspv.o \
		build/Debug/GNU-Linux-x86/MainWindowTab.o \
		build/Debug/GNU-Linux-x86/gsTransmit.o \
		build/Debug/GNU-Linux-x86/controller.o \
		build/Debug/GNU-Linux-x86/Transmit.o \
		build/Debug/GNU-Linux-x86/generalScreen.o \
		build/Debug/GNU-Linux-x86/MessageEditor.o \
		build/Debug/GNU-Linux-x86/gsTransmitSL.o \
		...
		build/Debug/GNU-Linux-x86/moc_MainWindowTab.o \
...
qttmp-Debug.mk: nbproject/qt-Debug.pro  ../../QtSDK/Desktop/Qt/474/gcc/mkspecs/common/g++.conf \
		../../QtSDK/Desktop/Qt/474/gcc/mkspecs/common/unix.conf \
		../../QtSDK/Desktop/Qt/474/gcc/mkspecs/common/linux.conf \
		../../QtSDK/Desktop/Qt/474/gcc/mkspecs/qconfig.pri \
		../../QtSDK/Desktop/Qt/474/gcc/mkspecs/modules/qt_webkit_version.pri \
...
dist: 
	@$(CHK_DIR_EXISTS) build/Debug/GNU-Linux-x86/SOURCE1.0.0 || $(MKDIR) build/Debug/GNU-Linux-x86/SOURCE1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Debug/GNU-Linux-x86/SOURCE1.0.0/ && $(COPY_FILE) --parents sferror.h controller.h MessageEditor.h Receive.h generalScreen.h gsReceive.h gsTransmitSL.h Transmit.h cannet.h msg.h gsMessageEditor.h Connection.h msgspv.h canlistener.h gsConnect.h MainWindowTab.h gsTransmit.h MainWindow.h gsReceiveSL.h canio.h build/Debug/GNU-Linux-x86/SOURCE1.0.0/ && $(COPY_FILE) --parents gsConnect.cpp MainWindow.cpp Connection.cpp canio.cpp cannet.cpp gsMessageEditor.cpp main.cpp msg.cpp Receive.cpp gsReceive.cpp gsReceiveSL.cpp msgspv.cpp MainWindowTab.cpp gsTransmit.cpp controller.cpp Transmit.cpp generalScreen.cpp MessageEditor.cpp gsTransmitSL.cpp build/Debug/GNU-Linux-x86/SOURCE1.0.0/ && (cd `dirname build/Debug/GNU-Linux-x86/SOURCE1.0.0` && $(TAR) SOURCE1.0.0.tar SOURCE1.0.0 && $(COMPRESS) SOURCE1.0.0.tar) && $(MOVE) `dirname build/Debug/GNU-Linux-x86/SOURCE1.0.0`/SOURCE1.0.0.tar.gz . && $(DEL_FILE) -r build/Debug/GNU-Linux-x86/SOURCE1.0.0
...
build/Debug/GNU-Linux-x86/gsConnect.o: gsConnect.cpp gsConnect.h \
		controller.h \
		canio.h \
		msg.h \
		sferror.h \
		cannet.h \
		canlistener.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/gsConnect.o gsConnect.cpp
...
build/Debug/GNU-Linux-x86/gsMessageEditor.o: gsMessageEditor.cpp gsMessageEditor.h \
		controller.h \
		canio.h \
		msg.h \
		sferror.h \
		...
		gsReceive.h \
		gsReceiveSL.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/gsMessageEditor.o gsMessageEditor.cpp

build/Debug/GNU-Linux-x86/main.o: main.cpp generalScreen.h \
		canlistener.h \
		msg.h \
		sferror.h \
		gsConnect.h \
...
build/Debug/GNU-Linux-x86/gsReceive.o: gsReceive.cpp gsReceive.h \
		gsReceiveSL.h \
		msg.h \
		sferror.h \
		controller.h \
		...
		cannet.h \
		canlistener.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/gsReceive.o gsReceive.cpp

build/Debug/GNU-Linux-x86/gsReceiveSL.o: gsReceiveSL.cpp gsReceiveSL.h \
		msg.h \
		sferror.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/gsReceiveSL.o gsReceiveSL.cpp

build/Debug/GNU-Linux-x86/msgspv.o: msgspv.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/msgspv.o msgspv.cpp

build/Debug/GNU-Linux-x86/MainWindowTab.o: MainWindowTab.cpp MainWindowTab.h \
		controller.h \
		canio.h \
		msg.h \
		sferror.h \
		...
		gsReceive.h \
		gsReceiveSL.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/MainWindowTab.o MainWindowTab.cpp

build/Debug/GNU-Linux-x86/gsTransmit.o: gsTransmit.cpp gsTransmit.h \
		gsTransmitSL.h \
		msg.h \
		sferror.h \
		controller.h \
		...
		cannet.h \
		canlistener.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/gsTransmit.o gsTransmit.cpp
...
build/Debug/GNU-Linux-x86/generalScreen.o: generalScreen.cpp generalScreen.h \
		canlistener.h \
		msg.h \
		sferror.h \
		gsConnect.h \
		...
		gsReceive.h \
		gsReceiveSL.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/generalScreen.o generalScreen.cpp
...
build/Debug/GNU-Linux-x86/gsTransmitSL.o: gsTransmitSL.cpp gsTransmitSL.h \
		msg.h \
		sferror.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/gsTransmitSL.o gsTransmitSL.cpp
...
build/Debug/GNU-Linux-x86/moc_MainWindowTab.o: moc_MainWindowTab.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o build/Debug/GNU-Linux-x86/moc_MainWindowTab.o moc_MainWindowTab.cpp
