...
# Generated by qmake (2.01a) (Qt 4.7.3) on: Tue Nov 22 19:32:11 2011
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) nbproject/build/Debug/GNU-Linux-x86/SOURCE1.0.0/ && $(COPY_FILE) --parents sferror.h controller.h MessageEditor.h Receive.h generalScreen.h gsReceive.h Transmit.h cannet.h msg.h gsMessageEditor.h Connection.h msgspv.h canlistener.h gsConnect.h gsTransmit.h MainWindow.h canio.h nbproject/build/Debug/GNU-Linux-x86/SOURCE1.0.0/ && $(COPY_FILE) --parents MainWindow.cpp Connection.cpp canio.cpp cannet.cpp main.cpp msg.cpp Receive.cpp msgspv.cpp controller.cpp Transmit.cpp MessageEditor.cpp nbproject/build/Debug/GNU-Linux-x86/SOURCE1.0.0/ && (cd `dirname nbproject/build/Debug/GNU-Linux-x86/SOURCE1.0.0` && $(TAR) SOURCE1.0.0.tar SOURCE1.0.0 && $(COMPRESS) SOURCE1.0.0.tar) && $(MOVE) `dirname nbproject/build/Debug/GNU-Linux-x86/SOURCE1.0.0`/SOURCE1.0.0.tar.gz . && $(DEL_FILE) -r nbproject/build/Debug/GNU-Linux-x86/SOURCE1.0.0
