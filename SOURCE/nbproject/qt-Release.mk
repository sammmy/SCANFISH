...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Wed Jan 11 03:02:31 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/Release/GNU-Linux-x86/SOURCE1.0.0/ && $(COPY_FILE) --parents sferror.h controller.h MessageEditor.h Receive.h generalScreen.h Transmit.h cannet.h msg.h Connection.h msgspv.h canlistener.h MainWindowTab.h gsConnect.h MainWindow.h canio.h build/Release/GNU-Linux-x86/SOURCE1.0.0/ && $(COPY_FILE) --parents gsConnect.cpp MainWindow.cpp Connection.cpp canio.cpp cannet.cpp main.cpp msg.cpp Receive.cpp msgspv.cpp MainWindowTab.cpp Transmit.cpp controller.cpp generalScreen.cpp MessageEditor.cpp build/Release/GNU-Linux-x86/SOURCE1.0.0/ && (cd `dirname build/Release/GNU-Linux-x86/SOURCE1.0.0` && $(TAR) SOURCE1.0.0.tar SOURCE1.0.0 && $(COMPRESS) SOURCE1.0.0.tar) && $(MOVE) `dirname build/Release/GNU-Linux-x86/SOURCE1.0.0`/SOURCE1.0.0.tar.gz . && $(DEL_FILE) -r build/Release/GNU-Linux-x86/SOURCE1.0.0
